...
# Public Inheritance For Members Of `protected` Zone

### Example 5 ~
Now let's see how public ineritance goes with protected members.
...
### Output
Clearly, we can access both the private and public members. This was possible because this time we can directly access the public function defined in the base class, which can access these members.
```cmd
------------------------------------
Employee Name : Saksham
Employee ID : 54214
...
# Protected Inheritance For Members Of `protected` Zone

### Example 6 ~
Here the inheritance visibility mode has been changed to `protected` .
...
// A class specifically designed to store the details of all the programmer employees working in a company. This class is inheriting from Employee Class 
class ProgrammerEmployee : protected Employee{
...
### Output ~
Clearly, it is working pretty much the same as private inheritance.

```cmd
.\05a-protected-domain-and-inheritance.cpp: In function 'int main()':
.\05a-protected-domain-and-inheritance.cpp:40:32: error: 'void Employee::addData(std::__cxx11::string, int)' is inaccessible within this context
     e1.addData("Saksham", 54214);
                                ^
.\05a-protected-domain-and-inheritance.cpp:14:14: note: declared here
         void addData(string name, int id){
              ^~~~~~~
.\05a-protected-domain-and-inheritance.cpp:40:32: error: 'Employee' is not an accessible base of 'ProgrammerEmployee'        
     e1.addData("Saksham", 54214);
                                ^
.\05a-protected-domain-and-inheritance.cpp:43:17: error: 'void Employee::viewData()' is inaccessible within this context     
     e1.viewData();
                 ^
.\05a-protected-domain-and-inheritance.cpp:19:14: note: declared here
         void viewData(){
              ^~~~~~~~
.\05a-protected-domain-and-inheritance.cpp:43:17: error: 'Employee' is not an accessible base of 'ProgrammerEmployee'
     e1.viewData();
```
